...
function add_update_experience(){
    $page_heading = isset($_GET['experience_id']) && $_GET['experience_id'] ? 'Update Experience': 'Add New Experience';
?>
<h1><?php echo esc_html__($page_heading, 'my-plugin'); ?></h1>
    <a class="float-right button button-primary button-large" href="<?php echo myPluginGetAdminPageUrl('experiences'); ?>"><?php echo esc_html__('Experiences', 'my-plugin'); ?></a>
<div class="form-tabs">
    <ul class="form-tabs-nav">
        <li class="form-tab-link active"
            data-tab="addExperienceInformation"><?php echo esc_html__('Information', 'my-plugin'); ?></li>
        <li class="form-tab-link"
            data-tab="addExperiencePricing"><?php echo esc_html__('Pricing', 'my-plugin'); ?></li>
        <li class="form-tab-link"
            data-tab="addExperienceImageGallery"><?php echo esc_html__('Image Gallery', 'my-plugin'); ?></li>
        <li class="form-tab-link"
            data-tab="addExperience360VirtualTour"><?php echo esc_html__('360° Virtual Tour', 'my-plugin'); ?></li>

        <li class="form-tab-link"
            data-tab="addExperienceVideo"><?php echo esc_html__('Video', 'my-plugin'); ?></li>
        <li class="form-tab-link"
            data-tab="addExperienceLocation"><?php echo esc_html__('Location', 'my-plugin'); ?></li>
        <li class="form-tab-link"
            data-tab="addExperienceBedrooms"><?php echo esc_html__('Bedrooms', 'my-plugin'); ?></li>
        <li class="form-tab-link"
            data-tab="addExperienceServices"><?php echo esc_html__('Services', 'my-plugin'); ?></li>
        <li class="form-tab-link"
            data-tab="addExperienceTermAndRules"><?php echo esc_html__('Terms & Rules', 'my-plugin'); ?></li>
        <li class="form-tab-link"
            data-tab="addExperienceSlider"><?php echo esc_html__('Slider', 'my-plugin'); ?></li>
        <li class="form-tab-link"
            data-tab="addExperienceSettings"><?php echo esc_html__('Settings', 'my-plugin'); ?></li>
    </ul>

    <div class="form-tab-content active" id="addExperienceInformation">
        <form class="form-table" method="post"
            ...
            <table>
                ...
                <tr class="form-field">
                    <th scope="row">
                        <label for="featured">Make this experience as featured?</label>
                    </th>
                    <td>
                ...
                <tr class="form-field">
                    ...
                    <td><input type="submit" name="submit" value="Add Experience"></td>
                </tr>
            </table>
        </form>
    </div>

    <div class="form-tab-content" id="addExperiencePricing">
        <form class="form-table" method="post"
              action="<?php echo esc_url(admin_url('admin.php?page=experiences')); ?>">
            <table>
                <tr class="form-field">
    ...
    <div class="form-tab-content" id="addExperienceImageGallery">
        this is tab 3 addExperienceImageGallery
    </div>

    <div class="form-tab-content" id="addExperience360VirtualTour">
        this is tab 4 addExperience360VirtualTour
    </div>

    <div class="form-tab-content" id="addExperienceVideo">
        this is tab 5 addExperienceVideo
    </div>

    <div class="form-tab-content" id="addExperienceLocation">
        this is tab 6 addExperienceLocation
    </div>

    <div class="form-tab-content" id="addExperienceWhatProvides">
        this is tab 7 addExperienceWhatProvides
    </div>

    <div class="form-tab-content" id="addExperienceWhatBrings">
        this is tab 7 addExperienceWhatBrings
    </div>

    <div class="form-tab-content" id="addExperienceServices">
        this is tab 8 addExperienceServices
    </div>

    <div class="form-tab-content" id="addExperienceTermAndRules">
        this is tab 9 addExperienceTermAndRules
    </div>

    <div class="form-tab-content" id="addExperienceSlider">
        this is tab 10 addExperienceSlider
    </div>

    <div class="form-tab-content" id="addExperienceSettings">
        this is tab 11 addExperienceSettings
    </div>
</div>
<?php } ?>
